#!/bin/bash
#SBATCH --job-name="Training@CLORT"
...
#SBATCH --error=job.clort_model_train_v1.err
#SBATCH --output=job.clort_model_train_v1.out
...
srun python $script_path/train.py $data_dir --batch_size 128 --n_epochs 10 --n_itr_logs 10 --log_id 0 --n_frames -1 --n_augs 5 \
--vis_loss_w 0.7 --pcl_loss_w 0.7 --enc_loss_w 1.0 --vis_lr 0.0007 --pcl_lr 0.0007 --enc_lr 0.0003 \
--itr_log_ln 10 --epoch_log_ln 1 --results_dir $out_dir --preload_model_path ''
